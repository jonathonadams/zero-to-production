export { CommonAuthComponentsModule } from './lib/common-auth-components.module';
...
export { CustomUsernameComponent } from './lib/custom-username/custom-username.components';
